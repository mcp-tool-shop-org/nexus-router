                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "call_tool",
                        "call": {"tool": "example_tool", "method": "example_method", "args": {}},
                    }
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "x",
                        "call": {"tool": "valid", "method": "method", "args": {}},
                    }
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "call",
                        "call": {"tool": "tool1", "method": "method1", "args": {}},
                    }
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "call1",
                        "call": {"tool": "tool1", "method": "m1", "args": {}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "call2",
                        "call": {"tool": "tool2", "method": "m2", "args": {}},
                    },
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "x",
                        "call": {"tool": "unknown_tool", "method": "method", "args": {}},
                    }
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "x",
                        "call": {"tool": "registered_tool", "method": "m", "args": {}},
                    }
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "x",
                        "call": {"tool": "t", "method": "discovered_method", "args": {}},
                    }
                ],
            }
        )
