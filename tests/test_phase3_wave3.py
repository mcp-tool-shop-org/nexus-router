...
class TestMultiToolWorkflows:
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "get_data",
                        "call": {"tool": "source", "method": "fetch", "args": {}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "process",
                        "call": {"tool": "processor", "method": "transform", "args": {}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "store",
                        "call": {"tool": "sink", "method": "save", "args": {}},
                    },
                ],
            }
        )
    ...
    def test_parallel_tool_execution_simulation(self, router_with_store):
        ...
        router, _store = router_with_store
                ...
                "plan_override": [
                    {
                        "step_id": "s1a",
                        "intent": "parallel_1",
                        "call": {"tool": "t1", "method": "m", "args": {}},
                    },
                    {
                        "step_id": "s1b",
                        "intent": "parallel_2",
                        "call": {"tool": "t2", "method": "m", "args": {}},
                    },
                    {
                        "step_id": "s1c",
                        "intent": "parallel_3",
                        "call": {"tool": "t3", "method": "m", "args": {}},
                    },
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "check",
                        "call": {"tool": "validator", "method": "check", "args": {}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "process",
                        "call": {"tool": "processor", "method": "run", "args": {}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "finalize",
                        "call": {"tool": "finalizer", "method": "complete", "args": {}},
                    },
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "try_primary",
                        "call": {"tool": "primary", "method": "run", "args": {}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "fallback",
                        "call": {"tool": "secondary", "method": "run", "args": {}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "final",
                        "call": {"tool": "tertiary", "method": "run", "args": {}},
                    },
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "composite_1",
                        "call": {"tool": "composite", "method": "op1", "args": {"data": "v1"}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "composite_2",
                        "call": {"tool": "composite", "method": "op2", "args": {"data": "v2"}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "composite_3",
                        "call": {"tool": "composite", "method": "op3", "args": {"data": "v3"}},
                    },
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "root",
                        "call": {"tool": "logic", "method": "decide", "args": {}},
                    },
                    {
                        "step_id": "s2a",
                        "intent": "branch_a",
                        "call": {"tool": "handler_a", "method": "run", "args": {}},
                    },
                    {
                        "step_id": "s2b",
                        "intent": "branch_b",
                        "call": {"tool": "handler_b", "method": "run", "args": {}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "merge",
                        "call": {"tool": "merger", "method": "combine", "args": {}},
                    },
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "outer_check",
                        "call": {"tool": "outer", "method": "check", "args": {}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "inner_check",
                        "call": {"tool": "inner", "method": "check", "args": {}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "action",
                        "call": {"tool": "action", "method": "execute", "args": {}},
                    },
                ],
            }
        )
        ...
        plan = [
            {
                "step_id": f"loop_{i}",
                "intent": f"iter_{i}",
                "call": {"tool": "processor", "method": "process", "args": {"iter": i}},
            }
            for i in range(5)
        ]
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "init",
                        "call": {"tool": "init", "method": "setup", "args": {"state": "init"}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "process",
                        "call": {"tool": "process", "method": "run", "args": {"state": "running"}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "finalize",
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "attempt",
                        "call": {"tool": "risky", "method": "run", "args": {}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "recover",
                        "call": {"tool": "recovery", "method": "repair", "args": {}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "retry",
                        "call": {"tool": "retry", "method": "execute", "args": {}},
                    },
                ],
            }
        )
        ...
        plan = [
            {
                "step_id": f"s{i}",
                "intent": f"event_{i}",
                "call": {"tool": "t", "method": "m", "args": {"id": i}},
            }
            for i in range(100)
        ]
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "event_1",
                        "call": {"tool": "t", "method": "m", "args": {"correlation_id": "cid_1"}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "event_2",
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "mutate_1",
                        "call": {"tool": "t", "method": "m", "args": {"mutation": "v1"}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "mutate_2",
                        "call": {"tool": "t", "method": "m", "args": {"mutation": "v2"}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "mutate_3",
                        "call": {"tool": "t", "method": "m", "args": {"mutation": "v3"}},
                    },
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "adapter_1",
                        "call": {"tool": "adapter_a", "method": "call", "args": {}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "adapter_2",
                        "call": {"tool": "adapter_b", "method": "call", "args": {}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "adapter_3",
                        "call": {"tool": "adapter_c", "method": "call", "args": {}},
                    },
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "send",
                        "call": {"tool": "sender", "method": "send", "args": {"data": "message"}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "receive",
                        "call": {"tool": "receiver", "method": "receive", "args": {}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "process",
                        "call": {"tool": "processor", "method": "process", "args": {}},
                    },
                ],
            }
        )
        ...
        resp = router.run(
            {
                ...
                "plan_override": [
                    ...
                    },
                    {
                        ...
                        "call": {"tool": "plugin_1", "method": "execute", "args": {}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "unload_plugin",
                        "call": {
                            "tool": "plugin_manager",
                            "method": "unload",
                            "args": {"plugin": "p1"},
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "middleware_1",
                        "call": {"tool": "middleware", "method": "auth", "args": {}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "middleware_2",
                        "call": {"tool": "middleware", "method": "validate", "args": {}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "middleware_3",
                        "call": {"tool": "middleware", "method": "log", "args": {}},
                    },
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "service_a",
                        "call": {"tool": "service_a", "method": "call", "args": {}},
                    },
                    {
                        "step_id": "s2",
                        "intent": "service_b",
                        "call": {"tool": "service_b", "method": "call", "args": {}},
                    },
                    {
                        "step_id": "s3",
                        "intent": "service_c",
                        "call": {"tool": "service_c", "method": "call", "args": {}},
                    },
                ],
            }
        )
