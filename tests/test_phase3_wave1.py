                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "x",
                        "call": {"tool": "valid_tool_name", "method": "m", "args": {}},
                    }
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "x",
                        "call": {"tool": "t", "method": "valid_method", "args": {}},
                    }
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "x",
                        "call": {"tool": "t", "method": "m", "args": {"password": "secret123"}},
                    }
                ],
            }
        )
                ...
                "plan_override": [
                    {
                        "step_id": "s1",
                        "intent": "x",
                        "call": {"tool": "nonexistent", "method": "m", "args": {}},
                    }
                ],
            }
        )
